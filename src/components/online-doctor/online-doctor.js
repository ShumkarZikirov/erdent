      ...
      <div className={'onlineDoctor'}>
          <div className={'onlineDoctor-main'}>
              <div className={'onlineDoctor-tittle'}>
                  <h5>Познакомьтесь С Нашими Сертифицированными Онлайн-Врачами</h5>
              </div>
              <div className={'onlineDoctor-volume'}>
                  <img src={volume} alt=""/>
              </div>
              ...
              <div className={'onlineDoctor-button'}>
                    <button>Исследуйте Всех Врачей</button>
              </div>
          </div>
      </div>
  )
